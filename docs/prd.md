...
Everything commercial and creative lives here, including **prices** — price is a
per-design decision, and the launch-low-then-raise workflow means it changes
often and should be visible in the file you're editing.
...
| 10 | Pricing | Explicit table per listing, optional per-colour overrides. Never set via Etsy API. |
