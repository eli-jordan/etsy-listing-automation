...
It holds the stable facts of a garment -- its blueprint, printer, print geometry
and fibre materials. Reused by every listing built on the same garment.
"""
...
class GarmentProfile(BaseModel):
    ...
    sizes: list[str]
    materials: list[str] = []
    """The fibre materials Etsy displays for this garment.

    A listing chooses a garment rather than independently describing its
    composition, so every listing using this profile sends the same materials
    to Etsy.
    """
