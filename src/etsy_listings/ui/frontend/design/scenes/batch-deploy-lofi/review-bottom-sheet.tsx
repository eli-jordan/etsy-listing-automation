...
import { ComparisonView } from "../../../src/pages/deploy/ComparisonView";
...
export const meta = {
  title: "Batch deployment — review all changes",
  viewport: "laptop",
  description:
  ...
  return (
    <div className="batch-review">
      <style>{`
        ...
        .batch-drawer { position:fixed; z-index:41; left:240px; right:0; bottom:0; height:min(74vh,740px); display:flex; flex-direction:column; background:var(--color-bg); border-top:1px solid var(--color-divider); box-shadow:var(--shadow-lg); transform:translateY(100%); transition:transform .22s ease-out; }
        ...
        .batch-drawer__body { flex:1 1 auto; min-height:0; display:grid; grid-auto-rows:max-content; align-content:start; gap:var(--space-4); padding:var(--space-4) var(--space-6) var(--space-6); overflow-y:auto; overscroll-behavior:contain; scrollbar-gutter:stable; touch-action:pan-y; }
      ...
      <div className="page-head">
        <button
          ...
          data-goto="batch-deploy-lofi/listings"
        >
          ← Back
        </button>
      ...
      >
        ...
        <div className="batch-drawer__body">
          ...
          <ComparisonView
            ...
            imageUrlForRef={(ref) => batchImageUrls[ref] ?? null}
          />
        </div>
      </aside>
    </div>
