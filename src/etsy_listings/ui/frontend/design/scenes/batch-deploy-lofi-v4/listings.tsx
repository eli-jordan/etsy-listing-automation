...
export const meta = {
  title: "Listings — batch deploy entry · v4",
  viewport: "laptop",
  description:
  ...
  return (
    <div>
      <style>{`
        ...
        .batch-deploy__button { min-width:176px; display:grid; grid-template-columns:1fr auto; gap:5px 10px; text-align:left; }
        .batch-deploy__button > svg { grid-column:2; grid-row:1 / span 2; width:16px; height:16px; }
        .batch-deploy__counts { display:flex; gap:5px; grid-column:1; font-family:var(--font-body); }
        .batch-deploy__counts .tag { font-weight:700; font-variant-numeric:tabular-nums; }
        ...
        <div className="page-head__actions">
          ...
          <div className="batch-deploy">
            <button
              ...
              data-goto="batch-deploy-lofi-v4/review-bottom-sheet"
            >
