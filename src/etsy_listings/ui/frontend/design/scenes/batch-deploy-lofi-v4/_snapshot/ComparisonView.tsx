import { pictureFor, singleDesignName } from "../../../../src/media";
import type { ListingDetail, RenderSnapshot } from "../../../../src/types";
import type {
  AfterImageTile,
  BeforeImageTile,
  Comparison as ComparisonData,
} from "../../../../src/pages/deploy/comparison";
import { wordDiff } from "../../../../src/pages/deploy/wordDiff";
